    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={handleSubmitRegister} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <PulsatingButton
                type="submit"
                className="w-full bg-blue-500 text-white  disabled:opacity-50 disabled:hover:bg-blue-500 disabled:cursor-not-allowed"
                pulseColor="#bfdbfe"
                disabled={isPending}
              >
                Register

...
import $api from "./api/axiosConfign";
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={handleSubmitLogin} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                <Input id="login" type="text" placeholder="jhondoe" required />
              </div>
              <div className="grid gap-3">
              ...
              <PulsatingButton
                type="submit"
                // add design disabled styles
                className="w-full bg-blue-500 text-white disabled:opacity-50 disabled:cursor-not-allowed "
                pulseColor="#bfdbfe"
                disabled={isPending}
              >
                Login
